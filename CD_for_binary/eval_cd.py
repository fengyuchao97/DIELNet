...
def main():
    ...
    parser.add_argument('--project_name', default='DIELNet-All', type=str) 
    ...
    parser.add_argument('--data_name', default='GZ', type=str) # test for GZ LEVIR+ WHU
    ...
    parser.add_argument('--net_G', default='DIELNet', type=str,
                        help='base_resnet18 | base_transformer_pos_s4_dd8 | base_transformer_pos_s4_dd8_dedim8 | MixAttNet5 | TCSVTNet0316 | DMINet_Final | CTFINet | ICIFNet')
