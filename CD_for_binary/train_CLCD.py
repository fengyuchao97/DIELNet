...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_name', default='DIELNet-All', type=str) #ASCNet_chunk2
    ...
    parser.add_argument('--net_G', default='DIELNet', type=str, # ASCNet_multi_granularity
