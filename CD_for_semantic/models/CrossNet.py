...
class MultiHeadCrossAttention(MultiHeadAttention):
    def __init__(self, channelY, channelS, ch_out, drop_rate=0.2,qkv_bias=False):
        ...
        self.factoratt_crpe_self = FactorAtt_ConvRelPosEnc(channelS,self.num_heads,qkv_bias=qkv_bias,proj_drop=drop_rate)
...
class MultiHeadCrossAttention_self(MultiHeadAttention):
    def __init__(self, channelY, channelS, ch_out, drop_rate=0.2,qkv_bias=False):
        super(MultiHeadCrossAttention_self, self).__init__()
        self.Sconv = nn.Sequential(
            nn.Conv2d(channelS, channelS, kernel_size=1),
            nn.BatchNorm2d(channelS), nn.ReLU(inplace=True))
        self.Yconv = nn.Sequential(
...
class MultiHeadCrossAttention_woca(MultiHeadAttention):
    def __init__(self, channelY, channelS, ch_out, drop_rate=0.2,qkv_bias=False):
        super(MultiHeadCrossAttention_woca, self).__init__()
        self.Sconv = nn.Sequential(
            nn.Conv2d(channelS, channelS, kernel_size=1),
            nn.BatchNorm2d(channelS), nn.ReLU(inplace=True))
        self.Yconv = nn.Sequential(
    ...
    def forward(self, Y, S):
        ...
        cur1 = self.factoratt_crpe(q_s, k_s, v_s, size).permute(0, 2, 1).reshape(Sb, Sc, Sh, Sw) 
        cur2 = self.factoratt_crpe(q_y, k_y, v_y, size).permute(0, 2, 1).reshape(Sb, Sc, Sh, Sw)
...
class MultiHeadCrossAttention_sa(MultiHeadAttention):
    def __init__(self, channelY, channelS, ch_out, drop_rate=0.2,qkv_bias=False):
        super(MultiHeadCrossAttention_sa, self).__init__()
        self.Sconv = nn.Sequential(
            nn.Conv2d(channelS, channelS, kernel_size=1),
            nn.BatchNorm2d(channelS), nn.ReLU(inplace=True))
        self.Yconv = nn.Sequential(
...
class MultiHeadCrossAttention_sa_woca(MultiHeadAttention):
    def __init__(self, channelY, channelS, ch_out, drop_rate=0.2,qkv_bias=False):
        super(MultiHeadCrossAttention_sa_woca, self).__init__()
        self.Sconv = nn.Sequential(
            nn.Conv2d(channelS, channelS, kernel_size=1),
            nn.BatchNorm2d(channelS), nn.ReLU(inplace=True))
        self.Yconv = nn.Sequential(
    ...
    def forward(self, Y, S):
        ...
        cur1 = self.factoratt_crpe(q_l, k_l, v_l, size).permute(0, 2, 1).reshape(Yb, Sc, Yh, Yw) 
        cur2 = self.factoratt_crpe(q_g, k_g, v_g, size).permute(0, 2, 1).reshape(Yb, Sc, Yh, Yw)
...
class ChannelAtt(nn.Module):
    def __init__(self, ch_in, r_2=1):
        super(ChannelAtt, self).__init__()
        # channel attention for F_g, use SE Block
        self.fc1 = nn.Conv2d(ch_in, ch_in // r_2, kernel_size=1)
        self.relu = nn.ReLU(inplace=True)
        self.fc2 = nn.Conv2d(ch_in // r_2, ch_in, kernel_size=1)
...
class CrossNet_Final(nn.Module):
    def __init__(self, num_classes=2, drop_rate=0.2, normal_init=True, pretrained=False, show_Feature_Maps=False):
        ...
        self.cross2 = MultiHeadCrossAttention(320, 320, ch_out=256, drop_rate=drop_rate/2, qkv_bias=True)
        ...
        self.Translayer2_2 = BasicConv2d(320,128,1)
    ...
    def forward(self, imgs1, imgs2, labels=None):
        ...
        cross_result2, cur1_2, cur2_2 = self.cross2(pvt[2], pvt_img2[2])
        cross_result3, cur1_3, cur2_3 = self.cross3(pvt[1], pvt_img2[1])
        cross_result4, cur1_4, cur2_4 = self.cross4(pvt[0], pvt_img2[0]) 
        ...
        return out, out_2, out_middle_1, out_middle_2
...
class CrossNet2(nn.Module):
    def __init__(self, num_classes=2, drop_rate=0.2, normal_init=True, pretrained=False, show_Feature_Maps=False):
        ...
        # self.cross1 = MultiHeadCrossAttention(512, 512, ch_out=512, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross2 = MultiHeadCrossAttention_self(256, 256, ch_out=256, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross3 = MultiHeadCrossAttention_self(128, 128, ch_out=128, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross4 = MultiHeadCrossAttention_self(64, 64, ch_out=64, drop_rate=drop_rate/2, qkv_bias=True)
...
class CrossNet3(nn.Module):
    def __init__(self, num_classes=2, drop_rate=0.2, normal_init=True, pretrained=False, show_Feature_Maps=False):
        ...
        # self.cross1 = MultiHeadCrossAttention(512, 512, ch_out=512, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross2 = MultiHeadCrossAttention3(256, 256, ch_out=256, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross3 = MultiHeadCrossAttention3(128, 128, ch_out=128, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross4 = MultiHeadCrossAttention3(64, 64, ch_out=64, drop_rate=drop_rate/2, qkv_bias=True)
    ...
    def forward(self, imgs1, imgs2, labels=None):
        ...
        cur1_2, cur2_2 = self.cross2(c3, c3_img2)
        cur1_3, cur2_3 = self.cross3(c2, c2_img2)
        cur1_4, cur2_4 = self.cross4(c1, c1_img2) 
...
class CrossNet4(nn.Module):
    def __init__(self, num_classes=2, drop_rate=0.2, normal_init=True, pretrained=False, show_Feature_Maps=False):
        ...
        self.fam21_1 = AlignBlock(256) # decode(320,320,320)
        self.Translayer2_1 = BasicConv2d(256,128,1)
        self.fam32_1 = AlignBlock(128) # decode(128,128,128)
        self.Translayer3_1 = BasicConv2d(128,64,1)
        self.fam43_1 = AlignBlock(64) # decode(64,64,64)

        self.Translayer1_2 = BasicConv2d(512,256,1)
        self.fam21_2 = AlignBlock(256) # decode(320,320,320)
        self.Translayer2_2 = BasicConv2d(256,128,1)
        self.fam32_2 = AlignBlock(128) # decode(128,128,128)
        self.Translayer3_2 = BasicConv2d(128,64,1)
        self.fam43_2 = AlignBlock(64) # decode(64,64,64)
    ...
    def forward(self, imgs1, imgs2, labels=None):
        ...
        cross_result1, cur1_1, cur2_1 = self.cross1(c4, c4_img2)
        cross_result2, cur1_2, cur2_2 = self.cross2(c3, c3_img2)
        cross_result3, cur1_3, cur2_3 = self.cross3(c2, c2_img2)
        cross_result4, cur1_4, cur2_4 = self.cross4(c1, c1_img2) 

        out2 = self.fam21_1(cross_result2, self.Translayer1_1(cross_result1))
        out3 = self.fam32_1(cross_result3, self.Translayer2_1(out2))
        out4 = self.fam43_1(cross_result4, self.Translayer3_1(out3))

        out2_2 = self.fam21_2(torch.abs(cur1_2-cur2_2), self.Translayer1_2(torch.abs(cur1_1-cur2_1)))
        out3_2 = self.fam32_2(torch.abs(cur1_3-cur2_3), self.Translayer2_2(out2_2))
        out4_2 = self.fam43_2(torch.abs(cur1_4-cur2_4), self.Translayer3_2(out3_2))
    ...
    def init_weights(self):
        ...
        self.Translayer1_2.apply(init_weights)
        self.fam32_2.apply(init_weights)
        self.Translayer2_2.apply(init_weights)
        self.fam43_2.apply(init_weights)
        self.Translayer3_2.apply(init_weights)
...
class CrossNet5(nn.Module):
    def __init__(self, num_classes=2, drop_rate=0.2, normal_init=True, pretrained=False, show_Feature_Maps=False):
        super(CrossNet5, self).__init__()
        ...
        # self.cross1 = MultiHeadCrossAttention(512, 512, ch_out=512, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross2 = MultiHeadCrossAttention_woca(256, 256, ch_out=256, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross3 = MultiHeadCrossAttention_woca(128, 128, ch_out=128, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross4 = MultiHeadCrossAttention_woca(64, 64, ch_out=64, drop_rate=drop_rate/2, qkv_bias=True)
...
class CrossNet6(nn.Module):
    def __init__(self, num_classes=2, drop_rate=0.2, normal_init=True, pretrained=False, show_Feature_Maps=False):
        super(CrossNet6, self).__init__()
        ...
        # self.cross1 = MultiHeadCrossAttention(512, 512, ch_out=512, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross2 = MultiHeadCrossAttention_sa(256, 256, ch_out=256, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross3 = MultiHeadCrossAttention_sa(128, 128, ch_out=128, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross4 = MultiHeadCrossAttention_sa(64, 64, ch_out=64, drop_rate=drop_rate/2, qkv_bias=True)
...
class CrossNet7(nn.Module):
    def __init__(self, num_classes=2, drop_rate=0.2, normal_init=True, pretrained=False, show_Feature_Maps=False):
        super(CrossNet7, self).__init__()
        ...
        # self.cross1 = MultiHeadCrossAttention(512, 512, ch_out=512, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross2 = MultiHeadCrossAttention_sa_woca(256, 256, ch_out=256, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross3 = MultiHeadCrossAttention_sa_woca(128, 128, ch_out=128, drop_rate=drop_rate/2, qkv_bias=True)
        self.cross4 = MultiHeadCrossAttention_sa_woca(64, 64, ch_out=64, drop_rate=drop_rate/2, qkv_bias=True)
...
class ClassSegNet(nn.Module):
    def __init__(self, num_classes=2, drop_rate=0.2, normal_init=True, pretrained=False, show_Feature_Maps=False):
        super(ClassSegNet, self).__init__()
        ...
        self.classifier1 = nn.Conv2d(in_channels=64, out_channels=num_classes-1, kernel_size=1, bias=False)
        self.classifier2 = nn.Conv2d(in_channels=64, out_channels=num_classes-1, kernel_size=1, bias=False)
    ...
    def forward(self, imgs1, imgs2, labels=None):
        ...
        # 使用Concat和Sub的分支进行分类任务
        class_predict1 = self.classifier1(out4)
        class_predict2 = self.classifier2(out_2)

        class_predict = class_predict1 or class_predict2

        print(class_predict.shape)
        return class_predict, out, out_2 #, out_middle_1, out_middle_2
