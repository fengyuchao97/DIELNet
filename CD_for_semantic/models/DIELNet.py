...
class DIELNet(nn.Module): 
    def __init__(self, num_classes=3, binary_classes=1, normal_init=True, pretrained=False):
        ...
        self.interaction3 = Interaction_multi_granularity(192, kernel_size=7, sr_ratio=1, num_groups=2, num_heads=8, chunk_numbers=[8,16])
        self.interaction2 = Interaction_multi_granularity(80, kernel_size=7, sr_ratio=2, num_groups=2, num_heads=4, chunk_numbers=[8,16]) 
        ...
        self.fam32_1 = MLLA_Align(136, 64, chunk_number=16)
        self.Translayer3_1 = BasicConv2d(64,32,1)
        self.fam43_1 = MLLA_Align(68, 32, chunk_number=16) 
    ...
    def forward(self, imgs, labels=None, return_aux=True):
        ...
        out2 = self.Translayer2_1(encoder_outputs[2])
        out3 = self.fam32_1(torch.cat([encoder_outputs[1], self.upsamplex2(out2)],1))
        out4 = self.fam43_1(torch.cat([encoder_outputs[0], self.upsamplex2(self.Translayer3_1(out3))],1)) 
        ...
        cur1_3, cur2_3 = self.interaction3(torch.cat([c6,c7],1), torch.cat([c6_img2,c7_img2],1)) 
        cur1_2, cur2_2 = self.interaction2(torch.cat([c4,c5],1), torch.cat([c4_img2,c5_img2],1)) 
        cur1_1, cur2_1 = self.interaction1(torch.cat([c2,c3],1), torch.cat([c2_img2,c3_img2],1)) 
        cur1_0, cur2_0 = self.interaction0(torch.cat([c0,c1],1), torch.cat([c0_img2,c1_img2],1)) 
