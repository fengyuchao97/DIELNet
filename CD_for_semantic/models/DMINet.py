...
class DMINet(nn.Module):
    def __init__(self, num_classes=3, drop_rate=0.2, normal_init=True, pretrained=False, show_Feature_Maps=False):
        ...
        self.final2_binary = nn.Sequential(
            Conv(64, 32, 3, bn=True, relu=True),
            Conv(32, 2, 3, bn=False, relu=False)
            )
    ...
    def forward(self, imgs1, imgs2, labels=None):
        ...
        out_1_binary = self.final_binary(out4_up)
        out_2_binary = self.final2_binary(out4_2_up)
        ...
        out_binary = self.sigmoid(out_1_binary+out_2_binary)
        return out_1, out_2, out_1_2, out_2_2, out_binary
    ...
    def init_weights(self):
        ...
        self.final2_binary.apply(init_weights)