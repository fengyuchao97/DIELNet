...
class vgg16_base(nn.Module):
    def __init__(self):
        ...
        model.load_state_dict(torch.load('./pretrained/vgg16-397923af.pth'))
...
class DSIFN(nn.Module):
    def __init__(self):
        ...
        self.o1_conv3 = nn.Conv2d(512, 3, 1)
        ...
        self.o2_conv4 = nn.Conv2d(256, 3, 1)
        ...
        self.o3_conv4 = nn.Conv2d(128, 3, 1)
        ...
        self.o4_conv4 = nn.Conv2d(64, 3, 1)
        ...
        self.o5_conv4 = nn.Conv2d(16, 3, 1)
        self.o5_conv4_binary = nn.Conv2d(16, 1, 1)
    ...
    def forward(self,t1_input,t2_input):
        ...
        branch_1_out = self.o1_conv3(x) #self.sigmoid()
        ...
        branch_2_out = self.o2_conv4(x)#self.sigmoid()
        ...
        branch_3_out = self.o3_conv4(x)#self.sigmoid()
        ...
        branch_4_out = self.o4_conv4(x)#self.sigmoid()
        ...
        branch_5_out = self.o5_conv4(x)#self.sigmoid()
        branch_5_out_binary = torch.sigmoid(self.o5_conv4_binary(x))
        # print(branch_5_out.size())
        return branch_5_out,branch_4_out,branch_3_out,branch_2_out,branch_1_out, branch_5_out_binary
