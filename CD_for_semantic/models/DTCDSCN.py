...
class CDNet_model(nn.Module):
    def __init__(self, in_channels, block, layers, num_classes=3):
        ...
        self.finalconv3_master_binary = nn.Conv2d(32, 1, 3, padding=1)
    ...
    def forward(self, x, y):
        ...
        output = self.finalconv3_master(out)
        
        output_binary = self.finalconv3_master_binary(out)
        return out1, out2, output, output_binary
