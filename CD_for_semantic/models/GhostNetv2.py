...
def ghostnetv2(**kwargs):
    ...
    return GhostNetV2(cfgs) #, num_classes=kwargs['num_classes'],  width=kwargs['width'],  dropout=kwargs['dropout'], args=kwargs['args']
...
# # state_dict ={k.replace('blocks.',''):v for k,v in torch.load('./pretrained/ck_ghostnetv2_10.pth.tar').items()}
