...
class SNUNet_ECAM(nn.Module):
    ...
    def __init__(self, in_ch=3, out_ch=3):
        ...
        n1 = 8     # the initial number of channels of feature map
        ...
        self.conv_final_binary = nn.Conv2d(filters[0] * 4, 1, kernel_size=1)
    ...
    def forward(self, xA, xB):
        ...
        ca1 = self.ca1(intra)
        feature = self.ca(out) * (out + ca1.repeat(1, 4, 1, 1))
        out = self.conv_final(feature)
        out_binary = torch.sigmoid(self.conv_final_binary(feature))
