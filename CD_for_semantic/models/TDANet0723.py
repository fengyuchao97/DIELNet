...
class TDANet_large_interact(nn.Module): 
    def __init__(self, num_classes=1, drop_rate=0., normal_init=True, pretrained=False, show_Feature_Maps=False):
        ...
        self.global_consrative2 = ContrastiveAtt_Block(192)
        self.global_consrative1 = ContrastiveAtt_Block(80)
        self.local_consrative2 = Local_Block(48, window_size=32)
        self.local_consrative1 = Local_Block(32, window_size=32)
