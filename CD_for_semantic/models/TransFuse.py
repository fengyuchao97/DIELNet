...
class TransFuse_S(nn.Module):
    ...
    def forward(self, imgs1, imgs2, labels=None):
        ...
        if self.show_Feature_Maps:
            savepath=r'temp'
            # draw_features(8,16,(F.interpolate(x_up_2, scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_Merge_8_img1.png".format(savepath))
            # draw_features(8,16,(F.interpolate(x_up_2_img2, scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_Merge_8_img2.png".format(savepath))

            # draw_features(8,16,(F.interpolate(out3_l, scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_CNN_8_img1.png".format(savepath))
            # draw_features(8,16,(F.interpolate(out3_l_img2, scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_CNN_8_img2.png".format(savepath))

            # draw_features(8,16,(F.interpolate(out3_g, scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_Trs_8_img1.png".format(savepath))
            # draw_features(8,16,(F.interpolate(out3_g_img2, scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_Trs_8_img2.png".format(savepath))

            draw_features(8,8,(F.interpolate(c1, scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_cnn_4_img1.png".format(savepath))
            draw_features(8,8,(F.interpolate(pvt[0], scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_pvt_4_img1.png".format(savepath))

            draw_features(8,8,(F.interpolate(c1_img2, scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_cnn_4_img2.png".format(savepath))
            draw_features(8,8,(F.interpolate(pvt_img2[0], scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_pvt_4_img2.png".format(savepath))

            draw_features(8,8,(F.interpolate(cross_4, scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_cross_4_img1.png".format(savepath))
            draw_features(8,8,(F.interpolate(curg_4, scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_curg_4_img1.png".format(savepath))
            draw_features(8,8,(F.interpolate(curl_4, scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_curl_4_img1.png".format(savepath))

            draw_features(8,8,(F.interpolate(cross_4_img2, scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_cross_4_img2.png".format(savepath))
            draw_features(8,8,(F.interpolate(curg_4_img2, scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_curg_4_img2.png".format(savepath))
            draw_features(8,8,(F.interpolate(curl_4_img2, scale_factor=8, mode='bilinear')).cpu().detach().numpy(),"{}/Out_curl_4_img2.png".format(savepath))
            ...
            draw_features(8,8,(F.interpolate(out2_l, scale_factor=4, mode='bilinear')).cpu().detach().numpy(),"{}/Out_CNN_4_img1.png".format(savepath))
            draw_features(8,8,(F.interpolate(out2_l_img2, scale_factor=4, mode='bilinear')).cpu().detach().numpy(),"{}/Out_CNN_4_img2.png".format(savepath))

            draw_features(8,8,(F.interpolate(out2_g, scale_factor=4, mode='bilinear')).cpu().detach().numpy(),"{}/Out_Trs_4_img1.png".format(savepath))
            draw_features(8,8,(F.interpolate(out2_g_img2, scale_factor=4, mode='bilinear')).cpu().detach().numpy(),"{}/Out_Trs_4_img2.png".format(savepath))
