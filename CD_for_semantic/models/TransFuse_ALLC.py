...
class TransFuse_ALLC(nn.Module):
    def __init__(self,num_classes=2, drop_rate=0.2, normal_init=True, pretrained=False):
        ...
        self.Translayer_up2 = BasicConv2d(256,128, 1)
        self.fam_up2 = decode(128,128,128)
        self.Translayer_up3 = BasicConv2d(128,64, 1)
        self.fam_up3 = decode(64,64,64)

        self.Translayer_up2_img2 = BasicConv2d(256,128, 1)
        self.fam_up2_img2 = decode(128,128,128)
        self.Translayer_up3_img2 = BasicConv2d(128,64, 1)
        self.fam_up3_img2 = decode(64,64,64)
    ...
    def forward(self, imgs1, imgs2, labels=None):
        ...
        x_up_2 = self.fam_up2(cross_3, self.Translayer_up2(cross_2))
        x_up_3 = self.fam_up3(cross_4, self.Translayer_up3(x_up_2))
        ...
        x_up_2_img2 = self.fam_up2_img2(cross_3_img2, self.Translayer_up2_img2(cross_2_img2))
        x_up_3_img2 = self.fam_up3_img2(cross_4_img2, self.Translayer_up3_img2(x_up_2_img2))
    ...
    def init_weights(self):
        ...
        self.Translayer_up2.apply(init_weights)
        self.fam_up2.apply(init_weights)
        self.Translayer_up3.apply(init_weights)
        self.fam_up3.apply(init_weights)

        self.Translayer_up2_img2.apply(init_weights)
        self.fam_up2_img2.apply(init_weights)
        self.Translayer_up3_img2.apply(init_weights)
        self.fam_up3_img2.apply(init_weights)
