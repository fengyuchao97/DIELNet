...
class TransFuse_ALLD(nn.Module):
    def __init__(self,num_classes=2, drop_rate=0.2, normal_init=True, pretrained=False):
        ...
        self.up2_g = Up(320, 128, 128, attn=True)
        self.up3_g = Up(128, 64, 64, attn=True)
        self.up2_l = Up(320, 128, 128, attn=True)
        self.up3_l = Up(128, 64, 64, attn=True)

        self.up2_g_img2 = Up(320, 128, 128, attn=True)
        self.up3_g_img2 = Up(128, 64, 64, attn=True)
        self.up2_l_img2 = Up(320, 128, 128, attn=True)
        self.up3_l_img2 = Up(128, 64, 64, attn=True)
    ...
    def forward(self, imgs1, imgs2, labels=None):
        ...
        x_up_2g = self.up2_g(curg_2, curg_3)
        x_up_3g = self.up3_g(x_up_2g, curg_4)

        x_up_2l = self.up2_l(curl_2, curl_3)
        x_up_3l = self.up3_l(x_up_2l, curl_4)
        ...
        x_up_3_img2 = self.up3_img2(x_up_2_img2 , cross_4_img2 )

        x_up_2g_img2 = self.up2_g_img2(curg_2, curg_3_img2)
        x_up_3g_img2 = self.up3_g(x_up_2g_img2, curg_4_img2)

        x_up_2l_img2 = self.up2_l_img2(curl_2_img2, curl_3_img2)
        x_up_3l_img2 = self.up3_l_img2(x_up_2l_img2, curl_4_img2)

        final2 = self.upsamplex4(torch.abs(x_up_3g-x_up_3g_img2))
        final1 = self.upsamplex4(torch.abs(x_up_3l-x_up_3l_img2))
    ...
    def init_weights(self):
        ...
        self.up2_g.apply(init_weights)
        self.up3_g.apply(init_weights)
        self.up2_l.apply(init_weights)
        self.up3_l.apply(init_weights)
        self.up2_g_img2.apply(init_weights)
        self.up3_g_img2.apply(init_weights)
        self.up2_l_img2.apply(init_weights)
        self.up3_l_img2.apply(init_weights)
