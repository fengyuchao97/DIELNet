...
class TransFuse_CNN(nn.Module):
    ...
    def forward(self, imgs1, imgs2, labels=None):
        ...
        curg_2, curl_2 = self.cross2(c3, pvt[2]) # 128 320 320
        curg_3, curl_3 = self.cross3(c2, pvt[1]) # 64 128 128
        curg_4, curl_4 = self.cross4(c1, pvt[0]) # 32 64 64

        out3_g = self.fam43_1(curg_3, self.Translayer2_g(curg_2))
        out2_g = self.fam32_1(curg_4, self.Translayer3_g(out3_g))

        curg_2_img2,curl_2_img2=self.cross2_img2(c3_img2,pvt_img2[2])
        curg_3_img2,curl_3_img2=self.cross3_img2(c2_img2,pvt_img2[1])
        curg_4_img2,curl_4_img2=self.cross4_img2(c1_img2,pvt_img2[0])
