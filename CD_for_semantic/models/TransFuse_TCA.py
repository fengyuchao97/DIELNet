...
class MultiHeadCrossAttention(MultiHeadAttention):
    def __init__(self, channelY, channelS, ch_out, drop_rate=0.2,qkv_bias=False):
        ...
        self.factoratt_crpe2 = FactorAtt_ConvRelPosEnc(channelS,self.num_heads,qkv_bias=qkv_bias,  proj_drop=drop_rate)
    ...
    def forward(self, Y, S):
        ...
        cur2 = self.factoratt_crpe2(q_l, k_g, v_g, size).permute(0, 2, 1).reshape(Yb, Sc, Yh, Yw)
