...
class TransFuse_WOMF(nn.Module):
    def __init__(self,num_classes=2, drop_rate=0.2, normal_init=True, pretrained=False):
        ...
        self.up2 = Cascaded_UP(256, 128, 128, attn=True)
        self.up3 = Cascaded_UP(128, 64, 64, attn=True)

        self.up2_img2 = Cascaded_UP(256, 128, 128, attn=True)
        self.up3_img2 = Cascaded_UP(128, 64, 64, attn=True)
        
        # low-level & high-level
        self.fam43_1 = Cascaded_UP(320, 128, 128, attn=True)
        self.fam32_1 = Cascaded_UP(128, 64, 64, attn=True)
        self.fam43_2 = Cascaded_UP(320, 128, 128, attn=True)
        self.fam32_2 = Cascaded_UP(128, 64, 64, attn=True)

        self.fam43_1_img2 = Cascaded_UP(320, 128, 128, attn=True)
        self.fam32_1_img2 = Cascaded_UP(128, 64, 64, attn=True)
        self.fam43_2_img2 = Cascaded_UP(320, 128, 128, attn=True)
        self.fam32_2_img2 = Cascaded_UP(128, 64, 64, attn=True)
    ...
    def forward(self, imgs1, imgs2, labels=None):
        ...
        out3_g = self.fam43_1(curg_2, curg_3)
        out2_g = self.fam32_1(out3_g, curg_4)

        out3_l = self.fam43_2(curl_2, curl_3)
        out2_l = self.fam32_2(out3_l, curl_4)
        ...
        out3_g_img2 = self.fam43_1_img2(curg_2_img2, curg_3_img2)
        out2_g_img2 = self.fam32_1_img2(out3_g_img2, curg_4_img2)

        out3_l_img2 = self.fam43_2_img2(curl_2_img2, curl_3_img2)
        out2_l_img2 = self.fam32_2_img2(out3_l_img2, curl_4_img2)
