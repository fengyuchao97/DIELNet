...
class TransFuse_only_CNN(nn.Module):
    ...
    def forward(self, imgs1, imgs2, labels=None):
        ...
        out3_g = self.fam43_1(c2, self.Translayer2_g(c3))
        out2_g = self.fam32_1(c1, self.Translayer3_g(out3_g))

        out3_g_img2 = self.fam43_1_img2(c2_img2, self.Translayer2_g_img2(c3_img2))
        out2_g_img2 = self.fam32_1_img2(c1_img2, self.Translayer3_g_img2(out3_g_img2))
