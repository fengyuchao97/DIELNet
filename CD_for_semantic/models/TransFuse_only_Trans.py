...
class TransFuse_only_Trans(nn.Module):
    ...
    def forward(self, imgs1, imgs2, labels=None):
        ...
        out3_g = self.fam43_1(pvt[1], self.Translayer2_g(pvt[2]))
        out2_g = self.fam32_1(pvt[0], self.Translayer3_g(out3_g))

        out3_g_img2 = self.fam43_1_img2(pvt_img2[1], self.Translayer2_g_img2(pvt_img2[2]))
        out2_g_img2 = self.fam32_1_img2(pvt_img2[0], self.Translayer3_g_img2(out3_g_img2))
