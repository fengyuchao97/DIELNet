...
#     (1, 1, 0) : 1,    # 类别 2 对应黄色 -> 新建
#     (1, 0, 0) : 2,    # 类别 3 对应红色 -> 拆除
#     (0, 0, 1) : 3     # 类别 4 对应蓝色 -> 重叠
# }
...
class CDEvaluator():
    ...
    def _collect_running_batch_states(self):
        ...
        if np.mod(self.batch_id, 1) == 0:
            ...
            vis_pred = utils.make_numpy_grid(de_norm(self._visualize_pred()))
            vis_gt = utils.make_numpy_grid(de_norm(self._visualize_gt()))
    ...
    def eval_models_inference_time(self, checkpoint_name='best_ckpt.pt'):
        self._load_checkpoint(checkpoint_name)
