...
class Hybrid(nn.Module):
    ...
    def forward(self, predictions, target):
        ce = cross_entropy(predictions, target.long())
        focal = self.focal(predictions, target.long())
        # dice = dice_loss(predictions, target.long())

        # return 0.8*ce+focal+dice # LOSS
        # return ce+focal+dice # LOSS3
        return ce+focal # LOSS4
        # return ce+dice # LOSS5
        # return focal+dice # LOSS6
