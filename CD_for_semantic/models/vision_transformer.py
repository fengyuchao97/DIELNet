...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768):
        ...
        num_patches = (img_size[1] // patch_size[1]) * (img_size[0] // patch_size[0])#196 224 16 224 16
        # num_patches=(math.ceil(math.sqrt(embed_dim))-in_chans)*(math.ceil(math.sqrt(embed_dim))-in_chans)
        self.img_size = img_size
        self.patch_size = patch_size
        self.num_patches = num_patches
        # print("self.num_patches:",self.num_patches,img_size[1],patch_size[1],img_size[0],patch_size[0])
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        # print("------------",hybrid_backbone,num_patches,"============")
